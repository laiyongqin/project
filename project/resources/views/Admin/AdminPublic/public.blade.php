...
<link rel="stylesheet" href="/static/admin/plugins/plupload/jquery.plupload.queue.css" media="screen">
<link rel="stylesheet" href="/static/admin/plugins/elfinder/css/elfinder.css" media="screen">
<link rel="stylesheet" type="text/css" href="/static/admin/custom-plugins/wizard/wizard.css" media="screen">
            ...
            <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-functions">
                    ...
                    <ul>
                        ...
                        <li><a href="/adminlogin/{change}/edit">Change Password</a></li>
                        <li><a href="/adminlogin/{logout}">退出</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/admingonggao/create">公告添加</a></li>
                            <li><a href="/admingonggao">公告列表</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                       ...
                       <li>
                        ...
                        <ul class="closed">
                            <li><a href="/ads/create">广告添加</a></li>
                            <li><a href="/ads">广告列表</a></li>
                        </ul>
                    </li>
                </ul>
            </div>         
...
<!-- Plugin Scripts -->
<script src="/static/admin/plugins/plupload/plupload.js"></script>
<script src="/static/admin/plugins/plupload/plupload.flash.js"></script>
<script src="/static/admin/plugins/plupload/plupload.html4.js"></script>
<script src="/static/admin/plugins/plupload/plupload.html5.js"></script>
<script src="/static/admin/plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.js"></script>
<script src="/static/admin/plugins/colorpicker/colorpicker-min.js"></script>
<script src="/static/admin/plugins/elfinder/js/elfinder.min.js"></script>
...
<script src="/static/admin/js/demo/demo.files.js"></script>
</body>
