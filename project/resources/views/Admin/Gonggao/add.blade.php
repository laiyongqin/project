...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form wzd-default wizard-form wizard-form-horizontal" action="/admingonggao" method="post">
            ...
            <fieldset class="wizard-step mws-form-inline" style="display: block;" data-wzd-id="wzd_1cm2vr1i51ojc1itc1s14_0">
                ...
                <div id="" class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input name="gname" class="required large" type="text">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <textarea name="gcontent" rows="" cols="" class="required large"></textarea>
                    </div>
                </div>
            </fieldset>
